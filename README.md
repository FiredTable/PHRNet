# Lite-PF-SHR
[Lite-PF-SHR: A Real-Time Highlight Suppression Network Based on Polarization Fusion] <br/>
Junzhuo Zhou, Ye Qiu, Zhihe Liu, Jun Zou, Jia Hao, Junyi Yang, Wenli Li, Yiting Yu  <br/>

## Demo Display
![Lite-SHR算法效果演示](./images/visual_comparisons_on_SHIQ_SSHR.png) <br/>
...
![Lite-PF-SHR算法效果演示](./images/pf_visual_comparisons_on_PSD.png) <br/>
*Figure 2: Visual comparison results of Lite-PF-SHR and other methods on the PSD dataset.*
...
```Shell
conda create -n PFSHR python=3.8
conda activate PFSHR
```
### Dependencies
